    ...
    <div class="header-content d-flex align-content-center " style="">
        ...
        <div class="header-list d-flex justify-content-end align-content-center row gx-0" >
            <div class="col-2 text-center no-opacity">
                <button class="btn-transparent px-3 intro" style="color: #207143">GIỚI THIỆU</button>
            </div>
            <div class="col-2 text-center no-opacity position-relative">
                <button class="btn-transparent px-3 product-sc-product"style="color: #207143">SẢN PHẨM</button>
                <div class="position-absolute hide_button" style=" margin-top: 3vh; background-color: white">
                    <button class="product-sc text-center btn-white btn-long py-2"style="color: #207143;">ĐÈN DOWNLIGHT</button>
                </div>
                <div class="position-absolute hide_button" style=" margin-top: 7vh; ">
                    <button class="product-sc-s text-center btn-white btn-long py-2"style="color: #207143;">ĐÈN SPOTLIGHT</button>
                </div>
                <div class="position-absolute hide_button" style=" margin-top: 11vh; ">
                    <button class="product-sc-r text-center btn-white btn-long py-2"style="color: #207143;">ĐÈN RAY NAM CHÂM </button>
                </div>
                <div class="position-absolute hide_button" style=" margin-top: 15vh; ">
                    <button class="product-sc-c text-center btn-white btn-long py-2"style="color: #207143;">CÔNG TẮC Ổ CẮM</button>
                </div>
            </div>
            <div class="col-2 text-center no-opacity">
                <button class="btn-transparent px-3 document" style="color: #207143">TÀI LIỆU</button>
            </div>
            <div class="col-2 text-center no-opacity">
