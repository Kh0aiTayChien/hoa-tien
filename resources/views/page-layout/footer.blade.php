<div class="footer" id="footer">
    <div class="container-fluid custom-padding">
        <h2 class="title" style="">
            <div class="row">
                <div class="col-md-8 col-xs-12">
                    ...
                    <div class="montserrat-bold text-white d-flex  d-md-none" style="letter-spacing: 0.35rem; font-size: 15px">HOA TIÊN PARADISE
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="form-group" style="">
                        <label for="contact_content" class="Montserrat-ExtraBold text-white mt-3" style="font-size: 13px">
                            YÊU CẦU CHI TIẾT
                        </label>
                        <br>
        ...
        <div class="row mt-5">
            <div class="col-md-5 col-xs-12"><img src="{{asset('images/footer/LOGOt.png')}}" alt="hoa-tien-image" loading="lazy"  class="img-fluid scrollToTop"></div>
