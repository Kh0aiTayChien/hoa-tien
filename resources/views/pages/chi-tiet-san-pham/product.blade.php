<div class="section-product mt-5" style="">
    <div class="row gx-5">
        <div class="col-lg-7 col-xs-12">
            <div class="main-img">
                <img src="{{$product->image}}" alt="hoa-tien-image" loading="lazy"  class="img-fluid w-100 large-image object-cover"
                     style="">
            </div>
            <div class="row mt-4 product-images d-flex flex-wrap" style="overflow-x: auto;">
                @foreach($mediaProducts as $media)
                    <div class="col-3">
                        <img src="{{$media->url}}" alt="hoa-tien-image" loading="lazy"  class="img-fluid small-image object-cover"
                             style="height: 100%; object-fit: cover">
                    </div>
                @endforeach
                <div class="col-3">
                    <img src="{{$product->image}}" alt="hoa-tien-image" loading="lazy"  class="img-fluid small-image object-cover"
                         style="height: 100%; object-fit: cover">
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-5 col-xs-12">
            <div class="d-none d-md-block">
                <div class="p-1 border-3 ms-3" style="border-color: #207143">
                    <div class=" mobile-name montserrat-bold px-4" style=" font-size: 25px">
                        {{$product->name}}</div>
                </div>
                <div class=" p-1 border-3 ms-3 mb-5" style="border-color: #207143">
                    <div class=" montserrat-bold ps-4" style="color: #207143; font-size: 3.09vw">
                        @if ($product->price == 0)
                            Liên hệ
                        @else
                ...
                <div class=" p-1  ms-3" style="border-color: #207143">
                ...
                <div class=" p-1 border-3 mb-5 ms-5 " style="border-color: #207143">
                    <a href="tel:0931 189 996">
                        <img src="{{asset('images/product/order.png')}}" alt="hoa-tien-image" loading="lazy"  class="img-fluid">
                    </a>
                </div>
            </div>

            <div class="d-block d-md-none">
                <div class="p-1 border-3 mt-5" style="border-color: #207143">
                    <div class=" montserrat-bold px-4 text-center" style=" font-size: 20px">
                        {{$product->name}}</div>
                </div>
                <div class=" p-1 border-3 mb-3" style="border-color: #207143">
                    <div class=" montserrat-bold  text-center" style="color: #207143; font-size: 29px">
                        @if ($product->price == 0)
                            Liên hệ
                        @else
                            {{ number_format($product->price, 0, ',', '.') }}
                ...
                <div class="  border-3 mb-3" style="border-color: #207143">
    ...
    <div class="horizontal-line-custom" style=" border-color: #207143; ">
        <div class=" montserrat-bold row" style="font-size: 25px; color: #207143">
    ...
    <div class="p-1 border-3 ms-1 mt-5 d-none d-md-block" style="border-color: #207143">
        <div class="content" style="font-size: 1rem; text-align: justify;">
            {!!$product->description !!}
        </div>
    </div>
<div class="p-1 border-3 ms-1 d-block d-md-none" style="border-color: #207143">
    <div class="content" style="font-size: 1rem; text-align: justify">
        {!!$product->description !!}
    </div>
</div>
    <div class=" p-1 border-3 mb-5 pt-5 d-flex align-content-center justify-content-center"
         style="border-color: #207143">
        <a class="btn btn-outline-info p-1 border-3" style="border-color: #207143" href="/">
            <div class="btn text-white montserrat-bold px-4" style="background-color: #207143; font-size: 15px">
...
<style>
    ...
    .horizontal-line {
        ...
        background-color: #207143; /* Màu sắc của đường */
    }
